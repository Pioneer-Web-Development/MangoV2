...
class Database
{
    ...
    /**
     * Fetches the result of an execution intended to be injected straight to a select option array.
     *
     * @return array Returns an Associate Array of results.
     */
    ...
    /**
     * Fetches the result of an execution as a simple numerical keyed array with values of the passed field.
     *
     * @return array Returns an Associate Array of results.
     */
    ...
    /*
     * Creates a log record containing calling script, time, user information (if available and assuming "user", message and last sql
     */
    ...
    private function executeLog()
    {
        ...
        $log= array('calling_script'=>$_SERVER['PHP_SELF'],
                    'called_timestamp'=>NOW(),
                    'called_user_id'=>$userid,
                    'sql' => $this->_last_query,
                    'message' => $this->logMessage
            );

        $this->insert('db_log',$log);
